...
func (_m *MockHistogramCollector) Execute(labels ...string) (elephant.Histogram, error) {
	...
	var r0 elephant.Histogram
	var r1 error
	if rf, ok := ret.Get(0).(func(...string) (elephant.Histogram, error)); ok {
		return rf(labels...)
	}
	if rf, ok := ret.Get(0).(func(...string) elephant.Histogram); ok {
		r0 = rf(labels...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(elephant.Histogram)
		}
	}
...
func (_c *MockHistogramCollector_Execute_Call) Return(_a0 elephant.Histogram, _a1 error) *MockHistogramCollector_Execute_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockHistogramCollector_Execute_Call) RunAndReturn(run func(...string) (elephant.Histogram, error)) *MockHistogramCollector_Execute_Call {
	_c.Call.Return(run)
	return _c
}
