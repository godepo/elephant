...
func (_m *MockHistogram) Observe(_a0 float64) {
	_m.Called(_a0)
}
...
//   - _a0 float64
func (_e *MockHistogram_Expecter) Observe(_a0 interface{}) *MockHistogram_Observe_Call {
	return &MockHistogram_Observe_Call{Call: _e.mock.On("Observe", _a0)}
}

func (_c *MockHistogram_Observe_Call) Run(run func(_a0 float64)) *MockHistogram_Observe_Call {
